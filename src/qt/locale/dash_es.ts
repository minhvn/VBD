...
<context>
    ...
    <message>
        <source>To use vbdd, or the -server option to dash-qt, you must set an rpcpassword in the configuration file:
%s
...
for example: alertnotify=echo %%s | mail -s "Dash Alert" admin@foo.com
        ...
        <translation>Para usar vbdd, o la opción -server de dash-qt, debe establecer rpcpassword en el archivo de configuración:
%s
